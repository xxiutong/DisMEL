...
if __name__ == "__main__":
    ...
    # ---------- paths ----------
    train_json = "/data/zyt/datas4/RichpediaMEL/RichpediaMEL_train_with_boxes_with_neg.json"
    # train_json = "/data/zyt/datas4/RichpediaMEL/RichpediaMEL_train_with_boxes.json"
    rank_path = "/data/zyt/datas4/RichpediaMEL/mel_pred_rank.npy"
    out_path = "/data/zyt/datas4/RichpediaMEL/RichpediaMEL_train_with_boxes_with_neg_sort10_32.json"

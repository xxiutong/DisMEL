...
if __name__ == "__main__":
    ...
    # ---------- paths ----------
    train_json = "/data/zyt/datas4/WikiMEL/WIKIMEL_train_with_boxes.json"
    rank_path = "/data/zyt/datas4/WikiMEL/mel_pred_rank.npy"
    out_path = "/data/zyt/datas4/WikiMEL/WIKIMEL_train_with_boxes_sort3_32.json"
